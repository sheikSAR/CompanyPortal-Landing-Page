  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-6">
              <Button
                variant="outline"
                className="border-black bg-white text-black font-bold px-10"
              >
                Logo
              </Button>
            </div>
      ...
      <section
        ...
        style={{
          backgroundImage:
            'linear-gradient(0deg, rgba(0, 0, 0, 0.60) 0%, rgba(0, 0, 0, 0.60) 100%), url("https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-4.0.3&auto=format&fit=crop&w=2340&q=80")',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white">
              ...
              <Button
                size="lg"
                className="bg-white text-black font-bold px-12 py-6 text-xl hover:bg-gray-100"
              >
                Access Talent Now
              </Button>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-black mb-6 leading-tight">
                Address the largest pain point that you solve and the "old way"
                while also tying in your unique benefit
              </h2>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Use this section to paint a vivid picture of the ideal prospects
                pain points and expose the flaws of the status quo to
                acknowledge you know what they are going through. Complement
                this with your unique value prop and differentiator.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
                Our solution does X, Y, Z (articulate main benefit you provide &
                explain how you do it in a proprietary or unique way).
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto text-center">
            <h2 className="text-4xl font-bold text-black mb-12">
              Benefit Driven headline - how you do it as well as what makes you
              different
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-4xl font-bold text-black text-center mb-12">
              How it works?{" "}
              {
                "{Make the perceived likelihood of achieving success high and effortless}"
              }
            </h2>
          ...
          <Accordion type="single" collapsible className="space-y-4">
            <AccordionItem value="item-1" className="border-b border-black">
              ...
              <AccordionContent className="text-gray-600 pb-6">
                ...
                you hire a candidate we sourced.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-2" className="border-b border-black">
              ...
              <AccordionContent className="text-gray-600 pb-6">
                ...
                developers use all the tools at their disposal.
              </AccordionContent>
            </AccordionItem>
      ...
      <section className="py-20 bg-white border-b border-black">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            Articulate the one final reason that people should get in touch and
            reach out to your company for your services or product. This is your
            last chance to grab their attention.
          </p>
          <Button className="bg-purple-600 text-white font-bold px-12 py-6 text-xl hover:bg-purple-700">
            MAIN ACTION TO TAKE
          </Button>
